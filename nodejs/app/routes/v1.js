...
//router.get(     '/messages',           passport.authenticate('jwt', {session:false}), MessageController.getAll);        // R
router.get(     '/messages',           MessageController.getAll);        // R

router.get(     '/latest-message',           MessageController.getLatest);        // R
